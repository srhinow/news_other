 ...
 */
class NewsOtherModel extends \Model
{
	 ...
	 * @param integer $currId      An ID from current show news that will not list
	 ...
	 */
	public static function findPublishedByPidsWithoutCurrent($arrPids, $currId, $blnFeatured=null, $intLimit=0, $intOffset=0, array $arrOptions=array())
	{
		...
		$t = static::$strTable;
		$arrColumns = array("$t.pid IN(" . implode(',', array_map('intval', $arrPids)) . ") AND $t.id != ".(int)$currId);
